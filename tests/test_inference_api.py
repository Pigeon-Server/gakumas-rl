...
from src.interfaces.inference_api import _resolve_server_config, create_inference_app
from src.interfaces.inference_service import InferenceResponse
...
def test_inference_api_uses_fixed_startup_service() -> None:
    ...
    with patch(
        'src.interfaces.inference_api._build_service',
